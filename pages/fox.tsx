...
export default function FoxPage() {
  return (
    <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 dark:from-gray-900 dark:to-gray-800 text-white min-h-screen font-sans">
      <header className="py-6 border-b border-white/10 backdrop-blur-sm bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700/90 sticky top-0 z-50 shadow-md shadow-black/10">
