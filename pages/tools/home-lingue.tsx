  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-blue-50 border border-blue-200 p-4 rounded-md shadow mb-6">
          <p className="text-lg font-medium text-blue-800">
            {saluti[lingua]}
          </p>
        </div>

        <div className="bg-yellow-50 border border-yellow-200 text-yellow-900 p-4 rounded-md shadow mb-6">
          <p className="text-sm">
